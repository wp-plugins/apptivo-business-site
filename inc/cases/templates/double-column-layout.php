...
echo '<div class="awformmain awdblclm absp_business_main cases_outfrm_'.$case_form[name].'">';
...
echo '<div class="formsection fullsection fullsecsub"><label><span>&nbsp;</span></label><div class="formrgt">'.$submit.'</div></div>';
