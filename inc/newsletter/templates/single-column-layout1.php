...
foreach($formfields as $field)
	{
		...
		switch($fieldtype)
		{
			...
			break;
			case "textarea":
				$html .=  '<textarea  name="'.$fieldid.'" id="'.$fieldid.'" value=""  class="absp_newsletter_textarea'.$validateclass.'"></textarea>';
			break;
			case "select":
     ...
     $html.='<input type="hidden" name="awp_newsletterform_submit"/>';
      ...
      $html .= '<input type="'.$newsletterform[submit_button_type].'" class="absp_newsletter_button_submit awp_contactform_submit_'.$newsletterform[name].'" '.$button_value.' name="awp_contactform_submit_'.$newsletterform[name].'"  id="awp_contactform_submit_'.$newsletterform[name].'" />';
      $html.='</div>';
      $html.='</form>';
      echo $css;
      echo $jscript;
