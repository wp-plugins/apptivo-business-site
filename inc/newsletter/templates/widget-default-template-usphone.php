...
echo $before_widget;
        ...
        if(strlen(trim($newsletterproperties[submit_button_val])) == 0)
         ...
         $button_value = 'src="'.$imgSrc.'"';
        			 ...
        			 $html .= '<br /><input type="'.$newsletterproperties[submit_button_type].'"  '.$button_value.' class="absp_newsletter_button_submit" name="'.$newsletterform[name].'_newsletterform_widget_submit"  id="'.$newsletterform[name].'newsletterform_widget_submit" />';
                     $html.='</form>';
                     echo $css;
                     echo $jscript;
                     echo $html;
