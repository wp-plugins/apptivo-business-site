...
foreach($formfields as $field)
	{
		...
		switch($fieldtype)
		{
			case "text":
			 ...
			 {
			 	 $html.='<input maxlength="3" size="3" type="text" name="'.$newsletterform[name].'_'.$fieldid.'1" id="'.$newsletterform[name].'_'.$fieldid.'1" value=""  class="absp_newsletter_input_text'.$validateclass.'">';
			 	 $html.='&nbsp;&nbsp;&nbsp;<input maxlength="3" size="3" type="text" name="'.$newsletterform[name].'_'.$fieldid.'2" id="'.$newsletterform[name].'_'.$fieldid.'2" value=""  class="absp_newsletter_input_text'.$validateclass.'">';
			 	 $html.='&nbsp;&nbsp;&nbsp;<input maxlength="4" size="4" type="text" name="'.$newsletterform[name].'_'.$fieldid.'3" id="'.$newsletterform[name].'_'.$fieldid.'3" value=""  class="absp_newsletter_input_text'.$validateclass.'">';
			 }
			 break;
			case "textarea":
     ...
     $html.='<input type="hidden" name="awp_newsletterform_submit"/>';
      ...
      $html .= '<input type="'.$newsletterform[submit_button_type].'" class="absp_newsletter_button_submit awp_newsletter_submit_'.$newsletterform[name].'" '.$button_value.' name="awp_newsletter_submit_'.$newsletterform[name].'"  id="awp_newsletter_submit_'.$newsletterform[name].'" />';
      $html.='</div>';
      $html.='</form>';
      echo $css;
      echo $jscript;
