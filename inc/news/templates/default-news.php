...
foreach($allnews as $News) {
 ...
 <div id="news0">                        
  ...
  <div class="absp_news_postmeta"><span class="absp_news_post">Posted: </span><span class="absp_news_postdate"><?php echo $dispDate; ?></span><?php  if(strlen($News->publishedBy) != 0) { ?><span class="absp_news_postby"> by </span><span class="absp_news_postauthor"><?php echo '<a href="'.$News->link.'" >'.$News->publishedBy.'</a></span>';?><?php } ?></div>
                        <div class="middle">
