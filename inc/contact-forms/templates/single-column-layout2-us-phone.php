...
echo '<style type="text/css">
    .awp_contactform_maindiv_'.$contactform[name].' .form_section{
    padding-bottom:10px;
    }
    .awp_contactform_maindiv_'.$contactform[name].' .form_section .form_left_part{
        width:30%;
        float:left;
        line-height:22px;
        }
        .awp_contactform_maindiv_'.$contactform[name].' .form_section .captcha{
           margin-top: 55px;
        }
        .submit {
        margin-left:30%;
        }
        .awp_contactform_maindiv_'.$contactform[name].' textarea{
        width: 177px;
        }
        .awp_contactform_maindiv_'.$contactform[name].' .awp_contactform_submit_'.$contactform[name].'{
          margin-left: 193px;
        }
      </style>';
...
echo '<form id="'.$contactform[name].'_contactforms" class="awp_contact_'.$contactform[name].'" name="'.$contactform[name].'_contactforms" action="'.$_SERVER['REQUEST_URI'].'" method="post">';
...
foreach($formfields as $field)
{
	...
	switch($fieldtype)
	{
		case "text":
			...
			{
				echo '<input maxlength="3" size="3" type="text" name="'.$fieldid.'1" id="'.$fieldid.'1" value="'.$postValue.'"  class="absp_contact_input_text'.$validateclass.'">';
				echo '&nbsp;&nbsp;&nbsp;<input maxlength="3" size="3" type="text" name="'.$fieldid.'2" id="'.$fieldid.'2" value="'.$postValue.'"  class="absp_contact_input_text'.$validateclass.'">';
				echo '&nbsp;&nbsp;&nbsp;<input maxlength="4" size="4" type="text" name="'.$fieldid.'3" id="'.$fieldid.'3" value="'.$postValue.'"  class="absp_contact_input_text'.$validateclass.'">';
			}
			break;
