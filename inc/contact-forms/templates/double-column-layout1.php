...
.awp_contactform_maindiv_'.$contactform['name'].' .form_rgt_part input[type="checkbox"], .awp_contactform_maindiv_'.$contactform['name'].' .form_rgt_part input[type="radio"]{width:auto ;float:left;margin:5px 0 0;}
.awp_contactform_maindiv_'.$contactform['name'].' .form_rgt_part select{padding:6px;width:100%;}
.awp_contactform_maindiv_'.$contactform['name'].' .form_rgt_part label{line-height:13px;word-wrap: break-word;}
...
.abswpcfm input[type="image"] {border:none;float:right;}
...
echo  '<form class="abswpcfm" id="'.$contactform['name'].'_contactforms" name="'.$contactform['name'].'_contactforms" action="'.$_SERVER['REQUEST_URI'].'" method="post">';
