...
foreach($formfields as $field)
	{
		...
		switch($fieldtype)
		{
			case "text":
			 ...
			 {
                 $html.='<input type="text" name="'.$fieldid.'" id="'.$fieldid.'" value=""  class="absp_contact_input_text'.$validateclass.'">';
			 }
			 else
			 {
			 	 $html.='<input maxlength="3" size="3" type="text" name="'.$fieldid.'1" id="'.$fieldid.'1" value=""  class="absp_contact_input_text'.$validateclass.'">';
			 	 $html.='&nbsp;&nbsp;&nbsp;<input maxlength="3" size="3" type="text" name="'.$fieldid.'2" id="'.$fieldid.'2" value=""  class="absp_contact_input_text'.$validateclass.'">';
			 	 $html.='&nbsp;&nbsp;&nbsp;<input maxlength="4" size="4" type="text" name="'.$fieldid.'3" id="'.$fieldid.'3" value=""  class="absp_contact_input_text'.$validateclass.'">';
			 }
             break;
			case "textarea":
