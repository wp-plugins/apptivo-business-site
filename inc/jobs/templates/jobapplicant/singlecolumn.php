...
.awp_contactform_maindiv_'.$hrjobsform['name'].'{max-width:700px;}
...
elseif($hrjobsform['confmsg_pagemode']=="other")
{
    ...
    echo  '<form id="'.$hrjobsform[name].'_hrjobsforms" class="awp_hrjobs_form abswpjfm" name="'.$hrjobsform[name].'_hrjobsforms" action="'.SITE_URL.'/'.$page_action.'" method="post">';
}
...
echo '<input type="hidden" value="'.$hrjobsform[name].'" name="awp_jobsformname" id="awp_jobsformname">';
echo '<div class="awformmain awsinglecolmn awp_hrjobsform_maindiv_'.$hrjobsform[name].'">';
...
echo '<div class="formsection"><div class="formrgt"><input type="'.$hrjobsform[submit_button_type].'" class="absp_jobapplicant_button_submit awp_hrjobsform_submit_'.$hrjobsform[name].'" '.$button_value.' name="awp_jobsform_submit" id="awp_jobsform_submit" /></div></div>';
echo '</div>';
