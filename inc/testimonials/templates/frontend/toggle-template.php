...
if ($testimonialform[tmpl_button_type] == "submit" && ($testimonialform[tmpl_button_val]) != "") {
    ...
    echo '<div class="awp-testimonial-post"><a href="javascript:void(0);" class="awp-testimonial-window"><button class="awp_tmpltype_btn">'.$button_value.'</button></a></div>';
} else {
    $button_value = $testimonialform[tmpl_button_val];
    echo '<div class="awp-testimonial-post"><a href="javascript:void(0);" class="awp-testimonial-window"><img class="tmpltype_btn_img" src="'.$button_value.'"/></a></div>';
}
